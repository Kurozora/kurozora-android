...
fun ThemeCard(
    ...
    val backgroundGradient = Brush.verticalGradient(
        colors = listOf(
            parseColor(theme.attributes.backgroundColor2),
            parseColor(theme.attributes.backgroundColor1)
        )
    )
        ...
        if (!isLarge) {
            ...
            Column(Modifier.fillMaxSize()) {
                    ...
                    KamelImage(
                        resource = {
                            asyncPainterResource(
                                theme.attributes.symbol?.url.toString()
                            )
                        },
                        contentDescription = theme.attributes.name,
                ...
                Column(
                    ...
                    Text(
                        text = theme.attributes.name.uppercase(),
                        color = Color.White,
                        style = MaterialTheme.typography.titleMedium
                    )

                    Text(
                        text = theme.attributes.description.orEmpty(),
...
//        ),
        ...
        Column(
            ...
            Box(
                ...
                KamelImage(
                    resource = {
                        asyncPainterResource(theme.attributes.symbol?.url.toString())
                    },
