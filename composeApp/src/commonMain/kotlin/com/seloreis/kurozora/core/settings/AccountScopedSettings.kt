package com.seloreis.kurozora.core.settings

import com.russhwolf.settings.Settings
import com.russhwolf.settings.set
import com.seloreis.kurozora.ui.theme.LocalThemeState
import com.seloreis.kurozora.ui.theme.ThemeController
import com.seloreis.kurozora.ui.theme.ThemeType
...
class AccountScopedSettings(
    ...
    var theme: String
        ...
        set(value) { settingsOrRoot[key(THEME_KEY)] = value }

    var language: String
        get() = settingsOrRoot.getStringOrNull(key(LANGUAGE_KEY)) ?: "en"
        set(value) { settingsOrRoot[key(LANGUAGE_KEY)] = value }

    var icon: String
        get() = settingsOrRoot.getStringOrNull(key(APP_ICON_KEY)) ?: "en"
        set(value) { settingsOrRoot[key(APP_ICON_KEY)] = value }
